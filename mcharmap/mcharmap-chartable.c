...
#include "mcharmap-unicode-info.h"
...
static void mcharmap_chartable_class_init (McharmapChartableClass *klass);
static void mcharmap_chartable_finalize   (GObject *object);
...
typedef AtkObjectFactory      McharmapChartableAccessibleFactory;
typedef AtkObjectFactoryClass McharmapChartableAccessibleFactoryClass;

static void
mcharmap_chartable_accessible_factory_init (McharmapChartableAccessibleFactory *factory)
{
}

static AtkObject*
mcharmap_chartable_accessible_factory_create_accessible (GObject *obj)
{
  return mcharmap_chartable_accessible_new (MCHARMAP_CHARTABLE (obj));
}

static GType
mcharmap_chartable_accessible_factory_get_accessible_type (void)
{
  return mcharmap_chartable_accessible_get_type ();
}

static void
mcharmap_chartable_accessible_factory_class_init (AtkObjectFactoryClass *klass)
{
  klass->create_accessible = mcharmap_chartable_accessible_factory_create_accessible;
  klass->get_accessible_type = mcharmap_chartable_accessible_factory_get_accessible_type;
}

static GType mcharmap_chartable_accessible_factory_get_type (void);
G_DEFINE_TYPE (McharmapChartableAccessibleFactory, mcharmap_chartable_accessible_factory, ATK_TYPE_OBJECT_FACTORY)

#endif

/* Type definition */

G_DEFINE_TYPE (McharmapChartable, mcharmap_chartable, GTK_TYPE_DRAWING_AREA)

/* utility functions */

static void
mcharmap_chartable_set_font_desc_internal (McharmapChartable *chartable,
                                            PangoFontDescription *font_desc /* adopting */)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
static void
mcharmap_chartable_emit_status_message (McharmapChartable *chartable,
                                         const char *message)
{
...
static void
get_root_coords_at_active_char (McharmapChartable *chartable, 
                                gint *x_root, 
                                gint *y_root)
{
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  col = _mcharmap_chartable_cell_column (chartable, priv->active_cell);

  *x_root = x + _mcharmap_chartable_x_offset (chartable, col);
  *y_root = y + _mcharmap_chartable_y_offset (chartable, row);
}

static void
get_active_cell_rect (McharmapChartable *chartable, GdkRectangle *rect)
{
  McharmapChartablePrivate *priv = chartable->priv;
  int row, col;
  ...
  rect->width = _mcharmap_chartable_column_width (chartable, col);
  rect->height = _mcharmap_chartable_row_height (chartable, row);
}

static void
get_appropriate_upper_left_xy (McharmapChartable *chartable, 
...
static guint
get_cell_at_rowcol (McharmapChartable *chartable,
                    gint            row,
                    gint            col)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
gint
_mcharmap_chartable_cell_column (McharmapChartable *chartable,
                              guint cell)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
...
gint
_mcharmap_chartable_column_width (McharmapChartable *chartable, gint col)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
gint
_mcharmap_chartable_x_offset (McharmapChartable *chartable, gint col)
{
  gint c, x;

  for (c = 0, x = 1;  c < col;  c++)
    x += _mcharmap_chartable_column_width (chartable, c);
...
gint
_mcharmap_chartable_row_height (McharmapChartable *chartable, gint row)
{
  McharmapChartablePrivate *priv = chartable->priv;
 ...
 * is the most readable */
gint
_mcharmap_chartable_y_offset (McharmapChartable *chartable, gint row)
{
  gint r, y;

  for (r = 0, y = 1;  r < row;  r++)
    y += _mcharmap_chartable_row_height (chartable, r);

  return y;
}

static void
set_top_row (McharmapChartable *chartable, 
             gint            row)
{
  McharmapChartablePrivate *priv = chartable->priv;
  gint r, c;
...
static PangoLayout *
layout_scaled_glyph (McharmapChartable *chartable, 
                     gunichar uc, 
                     double font_factor,
                     char **font_family)
{
  ...
  buf[mcharmap_unichar_to_printable_utf8 (uc, buf)] = '\0';
...
static GdkPixmap *
create_glyph_pixmap (McharmapChartable *chartable,
                     gunichar wc,
                     double font_factor,
...
static void
place_zoom_window (McharmapChartable *chartable, gint x_root, gint y_root)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GdkPixmap *pixmap;
...
static void
place_zoom_window_on_active_cell (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GdkPixmap *pixmap;
...
static int
get_font_size_px (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  GdkScreen *screen;
...
static void
update_zoom_window (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  GdkPixmap *pixmap;
  ...
  pixmap = create_glyph_pixmap (chartable,
                                mcharmap_chartable_get_active_character (chartable),
                                scale,
                                TRUE);
...
static void
make_zoom_window (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
...
static void
destroy_zoom_window (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
static void
mcharmap_chartable_show_zoom (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
static void
mcharmap_chartable_hide_zoom (McharmapChartable *chartable)
{
...
static void
mcharmap_chartable_set_active_cell (McharmapChartable *chartable,
                                     guint cell)
{
  McharmapChartablePrivate *priv = chartable->priv;
  int _cell = (int) cell;
...
static void
set_active_char (McharmapChartable *chartable,
                 gunichar        wc)
{
  McharmapChartablePrivate *priv = chartable->priv;

  guint cell = mcharmap_codepoint_list_get_index (priv->codepoint_list, wc);
  if (cell == -1) {
    gtk_widget_error_bell (GTK_WIDGET (chartable));
    return;
  }

  mcharmap_chartable_set_active_cell (chartable, cell);
}

static void
draw_borders (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  ...
  for (col = 0, x = 0;  col < priv->cols;  col++)
    {
      x += _mcharmap_chartable_column_width (chartable, col);
      gdk_draw_line (priv->pixmap,
                     style->dark_gc[GTK_STATE_NORMAL],
  ...
  for (row = 0, y = 0;  row < priv->rows;  row++)
    {
      y += _mcharmap_chartable_row_height (chartable, row);
      gdk_draw_line (priv->pixmap,
                     style->dark_gc[GTK_STATE_NORMAL],
...
static void
set_scrollbar_adjustment (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
/* for mouse clicks */
static gunichar
get_cell_at_xy (McharmapChartable *chartable, 
                gint            x, 
                gint            y)
{
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  for (c = 0, x0 = 0;  x0 <= x && c < priv->cols;  c++)
    x0 += _mcharmap_chartable_column_width (chartable, c);

  for (r = 0, y0 = 0;  y0 <= y && r < priv->rows;  r++)
    y0 += _mcharmap_chartable_row_height (chartable, r);
...
static void
draw_character (McharmapChartable *chartable, 
                gint            row, 
                gint            col)
{
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  wc = mcharmap_codepoint_list_get_char (priv->codepoint_list, cell);

  if (wc > UNICHAR_MAX || !mcharmap_unichar_validate (wc) || !mcharmap_unichar_isdefined (wc))
    return;
  ...
  square_width = _mcharmap_chartable_column_width (chartable, col) - 1;
  square_height = _mcharmap_chartable_row_height (chartable, row) - 1;

  n = mcharmap_unichar_to_printable_utf8 (wc, buf); 
  ...
  gdk_draw_layout (priv->pixmap, gc,
                   _mcharmap_chartable_x_offset (chartable, col) + padding_x,
                   _mcharmap_chartable_y_offset (chartable, row) + padding_y,
                   priv->pango_layout);
}

static void
draw_square_bg (McharmapChartable *chartable, gint row, gint col)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  gint square_width, square_height; 
  ...
  else if (! mcharmap_unichar_validate (wc))
    untinted = style->fg[GTK_STATE_INSENSITIVE];
  else if (! mcharmap_unichar_isdefined (wc))
  ...
  gdk_draw_rectangle (priv->pixmap, gc, TRUE,
                      _mcharmap_chartable_x_offset (chartable, col), 
		      _mcharmap_chartable_y_offset (chartable, row),
...
static void
expose_square (McharmapChartable *chartable, gint row, gint col)
{
  GtkWidget *widget = GTK_WIDGET (chartable);
  ...
  gtk_widget_queue_draw_area (widget,
                              _mcharmap_chartable_x_offset (chartable, col),
                              _mcharmap_chartable_y_offset (chartable, row),
                              _mcharmap_chartable_column_width (chartable, col) - 1,
                              _mcharmap_chartable_row_height (chartable, row) - 1);
}

static void
draw_square (McharmapChartable *chartable, gint row, gint col)
{
...
static void
draw_and_expose_cell (McharmapChartable *chartable,
                      guint cell)
{
  McharmapChartablePrivate *priv = chartable->priv;

  gint row = (cell - priv->page_first_cell) / priv->cols;
  gint col = _mcharmap_chartable_cell_column (chartable, cell);
...
static void
draw_chartable_from_scratch (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  gint row, col;
...
static void
copy_rows (McharmapChartable *chartable, gint row_offset)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  ...
  if (ABS (row_offset) < priv->rows - num_padded_rows)
    {
      ...
      height = _mcharmap_chartable_y_offset (chartable, num_rows) 
               - _mcharmap_chartable_y_offset (chartable, 0) - 1;

      gdk_draw_drawable (
              priv->pixmap,
              style->base_gc[GTK_STATE_NORMAL],
              priv->pixmap,
              0, _mcharmap_chartable_y_offset (chartable, from_row), 
              0, _mcharmap_chartable_y_offset (chartable, to_row),
...
static void
redraw_rows (McharmapChartable *chartable, gint row_offset)
{
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  for (row = 0;  row <= priv->rows;  row++)
    {
      ...
      if (row + row_offset >= 0 && row + row_offset <= priv->rows)
        {
          draw_row = draw_row || (_mcharmap_chartable_row_height (chartable, row) 
                                  != _mcharmap_chartable_row_height (chartable,  
                                                         row + row_offset));
        }
...
void
_mcharmap_chartable_redraw (McharmapChartable *chartable, 
                         gboolean        move_zoom)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
...
static void
update_scrollbar_adjustment (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
static void
vadjustment_value_changed_cb (GtkAdjustment *adjustment, McharmapChartable *chartable)
{
  set_top_row (chartable, (gint) gtk_adjustment_get_value (adjustment));
  _mcharmap_chartable_redraw (chartable, TRUE);
}
 ...
 */
static gboolean
mcharmap_chartable_button_press (GtkWidget *widget,
                                  GdkEventButton *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  /* single-click */ 
    ...
    {
      mcharmap_chartable_set_active_cell (chartable, get_cell_at_xy (chartable, event->x, event->y));
      _mcharmap_chartable_redraw (chartable, TRUE);
    }
  else if (event->button == 3)
    {
      mcharmap_chartable_set_active_cell (chartable, get_cell_at_xy (chartable, event->x, event->y));
      _mcharmap_chartable_redraw (chartable, FALSE); /* FIXMEchpe */
...
static gboolean
mcharmap_chartable_button_release (GtkWidget *widget,
                                    GdkEventButton *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  gboolean (* button_press_event) (GtkWidget *, GdkEventButton *) =
    GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->button_release_event;

  if (event->button == 3)
    mcharmap_chartable_hide_zoom (chartable);
...
static void
mcharmap_chartable_drag_begin (GtkWidget *widget,
...
static void
mcharmap_chartable_drag_data_get (GtkWidget *widget, 
                                   GdkDragContext *context,
...

{
  ...
  n = g_unichar_to_utf8 (mcharmap_codepoint_list_get_char (priv->codepoint_list, priv->active_cell), buf);
...
static void
mcharmap_chartable_drag_data_received (GtkWidget *widget,
                                        GdkDragContext *context,
                                        gint x, gint y,
                                        GtkSelectionData *selection_data,
                                        guint info,
                                        guint time)
{
  ...
  if (wc == (gunichar)(-2) || wc == (gunichar)(-1) || wc > UNICHAR_MAX)
    mcharmap_chartable_emit_status_message (chartable, _("Unknown character, unable to identify."));
  else if (mcharmap_codepoint_list_get_index (priv->codepoint_list, wc) == (guint)(-1))
    mcharmap_chartable_emit_status_message (chartable, _("Not found."));
  else
    {
      mcharmap_chartable_emit_status_message (chartable, _("Character found."));
...
static gboolean
mcharmap_chartable_expose_event (GtkWidget *widget, 
...
static gboolean
mcharmap_chartable_focus_in_event (GtkWidget *widget, 
                                    GdkEventFocus *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  return GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->focus_in_event (widget, event);
}

static gboolean
mcharmap_chartable_focus_out_event (GtkWidget *widget,
                                     GdkEventFocus *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  return GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->focus_out_event (widget, event);
}

static gboolean
mcharmap_chartable_key_press_event (GtkWidget *widget,
                                     GdkEventKey *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);

  if (event->state & (GDK_MOD1_MASK | GDK_CONTROL_MASK))
    return GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->key_press_event (widget, event);

  switch (event->keyval)
    {
      case GDK_Shift_L: case GDK_Shift_R:
        mcharmap_chartable_show_zoom (chartable);
        break;
...
static gboolean
mcharmap_chartable_key_release_event (GtkWidget *widget,
                                       GdkEventKey *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  ...
  return GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->key_release_event (widget, event);
}

static gboolean
mcharmap_chartable_motion_notify (GtkWidget *widget,
                                   GdkEventMotion *event)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;
  gboolean (* motion_notify_event) (GtkWidget *, GdkEventMotion *) =
    GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->motion_notify_event;
  ...
  if ((event->state & GDK_BUTTON1_MASK) &&
      gtk_drag_check_threshold (widget,
                                ...
                                event->x,
                                event->y) &&
      mcharmap_unichar_validate (mcharmap_chartable_get_active_character (chartable)))
    {
      ...
      if ((gint)cell != priv->active_cell)
        {
          ...
          mcharmap_chartable_set_active_cell (chartable, cell);
          _mcharmap_chartable_redraw (chartable, FALSE);
        }
...
static void
mcharmap_chartable_realize (GtkWidget *widget)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;

  GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->realize (widget);
...
static void
mcharmap_chartable_size_allocate (GtkWidget *widget,
                                   GtkAllocation *allocation)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->size_allocate (widget, allocation);
...
static void
mcharmap_chartable_size_request (GtkWidget *widget,
...
static void
mcharmap_chartable_style_set (GtkWidget *widget, 
                               GtkStyle *previous_style)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (widget);
  McharmapChartablePrivate *priv = chartable->priv;

  GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->style_set (widget, previous_style);
  ...
  if (priv->font_desc == NULL) {
    ...
    mcharmap_chartable_set_font_desc_internal (chartable, font_desc /* adopts */);
    g_assert (priv->font_desc != NULL);
  }
...
static AtkObject *
mcharmap_chartable_get_accessible (GtkWidget *widget)
{
  ...
  if (first_time)
    {
       ...
       * the parent type of McharmapChartable.
       */
	...
	atk_registry_set_factory_type (registry, 
				       ...
				       mcharmap_chartable_accessible_factory_get_type ());
      first_time = FALSE;
    }

  return GTK_WIDGET_CLASS (mcharmap_chartable_parent_class)->get_accessible (widget);
}

#endif

/* McharmapChartable class methods */

static void
mcharmap_chartable_set_adjustments (McharmapChartable *chartable,
...
static void
mcharmap_chartable_add_move_binding (GtkBindingSet  *binding_set,
                                      guint           keyval,
                                      guint           modmask,
...
static void
mcharmap_chartable_move_cursor_left_right (McharmapChartable *chartable,
                                            int count)
{
  McharmapChartablePrivate *priv = chartable->priv;
  GtkWidget *widget = GTK_WIDGET (chartable);
  ...
  if (new_cell >= 0 &&
    ...
    mcharmap_chartable_set_active_cell (chartable, new_cell);
}

static void
mcharmap_chartable_move_cursor_up_down (McharmapChartable *chartable,
                                         int count)
{
  McharmapChartablePrivate *priv = chartable->priv;
  int new_cell;
...
static void
mcharmap_chartable_move_cursor_page_up_down (McharmapChartable *chartable,
                                              int count)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
static void
mcharmap_chartable_move_cursor_start_end (McharmapChartable *chartable,
                                           int count)
{
  McharmapChartablePrivate *priv = chartable->priv;
  int new_cell;
...
static gboolean
mcharmap_chartable_move_cursor (McharmapChartable *chartable,
                                 GtkMovementStep     step,
                                 int                 count)
{
  ...
  switch (step)
    ...
    case GTK_MOVEMENT_VISUAL_POSITIONS:
      mcharmap_chartable_move_cursor_left_right (chartable, count);
      break;
    case GTK_MOVEMENT_DISPLAY_LINES:
      mcharmap_chartable_move_cursor_up_down (chartable, count);
      break;
    case GTK_MOVEMENT_PAGES:
      mcharmap_chartable_move_cursor_page_up_down (chartable, count);
      break;
    case GTK_MOVEMENT_BUFFER_ENDS:
      mcharmap_chartable_move_cursor_start_end (chartable, count);
      break;
    default:
...
static void
mcharmap_chartable_copy_clipboard (McharmapChartable *chartable)
{
...
static void
mcharmap_chartable_paste_received_cb (GtkClipboard *clipboard,
                                       const char *text,
                                       gpointer user_data)
{
  gpointer *data = (gpointer *) user_data;
  McharmapChartable *chartable = *data;
  gunichar wc;
  ...
  wc = g_utf8_get_char_validated (text, -1);
  if (wc == 0 ||
      !mcharmap_unichar_validate (wc)) {
    gtk_widget_error_bell (GTK_WIDGET (chartable));
    return;
  }

  mcharmap_chartable_set_active_character (chartable, wc);
}

static void
mcharmap_chartable_paste_clipboard (McharmapChartable *chartable)
{
  GtkClipboard *clipboard;
  gpointer *data;
  ...
  *data = chartable;
  ...
  gtk_clipboard_request_text (clipboard,
                              mcharmap_chartable_paste_received_cb,
                              data);
}

/* does all the initial construction */
static void
mcharmap_chartable_init (McharmapChartable *chartable)
{
  GtkWidget *widget = GTK_WIDGET (chartable);
  McharmapChartablePrivate *priv;

  priv = chartable->priv = G_TYPE_INSTANCE_GET_PRIVATE (chartable, MCHARMAP_TYPE_CHARTABLE, McharmapChartablePrivate);
...
/*  gtk_widget_set_double_buffered (widget, FALSE); */
  ...
  mcharmap_chartable_set_codepoint_list (chartable, NULL);

  gtk_widget_show_all (GTK_WIDGET (chartable));
}

static void
mcharmap_chartable_finalize (GObject *object)
{
  McharmapChartable *chartable = MCHARMAP_CHARTABLE (object);
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  G_OBJECT_CLASS (mcharmap_chartable_parent_class)->finalize (object);
}

static void
mcharmap_chartable_set_property (GObject *object,
                                  guint prop_id,
                                  const GValue *value,
                                  GParamSpec *pspec)
{
  ...
  switch (prop_id) {
    case PROP_ACTIVE_CHAR:
      mcharmap_chartable_set_active_character (chartable, g_value_get_uint (value));
      break;
    case PROP_CODEPOINT_LIST:
      mcharmap_chartable_set_codepoint_list (chartable, g_value_get_object (value));
      break;
    case PROP_FONT_DESC:
      mcharmap_chartable_set_font_desc (chartable, g_value_get_boxed (value));
      break;
    case PROP_SNAP_POW2:
      mcharmap_chartable_set_snap_pow2 (chartable, g_value_get_boolean (value));
      break;
    case PROP_ZOOM_ENABLED:
      mcharmap_chartable_set_zoom_enabled (chartable, g_value_get_boolean (value));
      break;
...
static void
mcharmap_chartable_get_property (GObject *object,
                                  guint prop_id,
                                  GValue *value,
                                  GParamSpec *pspec)
{
  ...
  switch (prop_id) {
    case PROP_ACTIVE_CHAR:
      g_value_set_uint (value, mcharmap_chartable_get_active_character (chartable));
      break;
    case PROP_CODEPOINT_LIST:
      g_value_set_object (value, mcharmap_chartable_get_codepoint_list (chartable));
      break;
    case PROP_FONT_DESC:
      g_value_set_boxed (value, mcharmap_chartable_get_font_desc (chartable));
      break;
    case PROP_SNAP_POW2:
...
static void
mcharmap_chartable_class_init (McharmapChartableClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
  GtkBindingSet *binding_set;

  g_type_class_add_private (object_class, sizeof (McharmapChartablePrivate));

  object_class->finalize = mcharmap_chartable_finalize;
  object_class->get_property = mcharmap_chartable_get_property;
  object_class->set_property = mcharmap_chartable_set_property;

  widget_class->drag_begin = mcharmap_chartable_drag_begin;
  widget_class->drag_data_get = mcharmap_chartable_drag_data_get;
  widget_class->drag_data_received = mcharmap_chartable_drag_data_received;
  widget_class->button_press_event = mcharmap_chartable_button_press;
  widget_class->button_release_event = mcharmap_chartable_button_release;
  widget_class->expose_event = mcharmap_chartable_expose_event;
  widget_class->focus_in_event = mcharmap_chartable_focus_in_event;
  widget_class->focus_out_event = mcharmap_chartable_focus_out_event;
  widget_class->key_press_event = mcharmap_chartable_key_press_event;
  widget_class->key_release_event = mcharmap_chartable_key_release_event;
  widget_class->motion_notify_event = mcharmap_chartable_motion_notify;
  widget_class->realize = mcharmap_chartable_realize;
  widget_class->size_allocate = mcharmap_chartable_size_allocate;
  widget_class->size_request = mcharmap_chartable_size_request;
  widget_class->style_set = mcharmap_chartable_style_set;
#ifdef ENABLE_ACCESSIBLE
  widget_class->get_accessible = mcharmap_chartable_get_accessible;
#endif

  klass->set_scroll_adjustments = mcharmap_chartable_set_adjustments;
  klass->move_cursor = mcharmap_chartable_move_cursor;
  klass->activate = NULL;
  klass->copy_clipboard = mcharmap_chartable_copy_clipboard;
  klass->paste_clipboard = mcharmap_chartable_paste_clipboard;
  ...
  widget_class->activate_signal = signals[ACTIVATE] =
    g_signal_new (I_("activate"),
                  ...
                  G_STRUCT_OFFSET (McharmapChartableClass, activate),
                  NULL, NULL,
  ...
  /**
   * McharmapChartable::set-scroll-adjustments
   * @horizontal: the horizontal #GtkAdjustment
   * @vertical: the vertical #GtkAdjustment
   *
   * Set the scroll adjustments for the text view. Usually scrolled containers
   * like #GtkScrolledWindow will emit this signal to connect two instances
   * of #GtkScrollbar to the scroll directions of the #McharmapChartable.
   */
  widget_class->set_scroll_adjustments_signal =
    g_signal_new (I_("set-scroll-adjustments"),
                  G_TYPE_FROM_CLASS (object_class),
                  G_SIGNAL_RUN_LAST,
                  G_STRUCT_OFFSET (McharmapChartableClass, set_scroll_adjustments),
                  NULL, NULL, 
                  _mcharmap_marshal_VOID__OBJECT_OBJECT,
                  G_TYPE_NONE, 2,
                  GTK_TYPE_ADJUSTMENT, GTK_TYPE_ADJUSTMENT);

  signals[STATUS_MESSAGE] =
    g_signal_new (I_("status-message"), mcharmap_chartable_get_type (), G_SIGNAL_RUN_FIRST,
                  G_STRUCT_OFFSET (McharmapChartableClass, status_message),
  ...
  signals[MOVE_CURSOR] =
    g_signal_new (I_("move-cursor"),
                  G_TYPE_FROM_CLASS (object_class),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (McharmapChartableClass, move_cursor),
                  NULL, NULL,
                  _mcharmap_marshal_BOOLEAN__ENUM_INT,
                  G_TYPE_BOOLEAN, 2,
  ...
  signals[COPY_CLIPBOARD] =
    g_signal_new (I_("copy-clipboard"),
                  ...
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (McharmapChartableClass, copy_clipboard),
                  NULL, NULL,
                  g_cclosure_marshal_VOID__VOID,
                  G_TYPE_NONE, 0);
  ...
  signals[PASTE_CLIPBOARD] =
    g_signal_new (I_("paste-clipboard"),
                  G_OBJECT_CLASS_TYPE (object_class),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (McharmapChartableClass, paste_clipboard),
                  NULL, NULL,
                  g_cclosure_marshal_VOID__VOID,
                  G_TYPE_NONE, 0);
  ...
  g_object_class_install_property
    (object_class,
     ...
     g_param_spec_object ("codepoint-list", NULL, NULL,
                          mcharmap_codepoint_list_get_type (),
                          G_PARAM_READWRITE |
                          G_PARAM_STATIC_NAME |
                          G_PARAM_STATIC_NICK |
                          G_PARAM_STATIC_BLURB));
  ...
  /* Cursor movement */
  mcharmap_chartable_add_move_binding (binding_set, GDK_Up, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Up, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Down, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Down, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, 1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_p, GDK_CONTROL_MASK,
                                        GTK_MOVEMENT_DISPLAY_LINES, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_n, GDK_CONTROL_MASK,
                                        GTK_MOVEMENT_DISPLAY_LINES, 1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Home, 0,
                                        GTK_MOVEMENT_BUFFER_ENDS, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Home, 0,
                                        GTK_MOVEMENT_BUFFER_ENDS, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_End, 0,
                                        GTK_MOVEMENT_BUFFER_ENDS, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_End, 0,
                                        GTK_MOVEMENT_BUFFER_ENDS, 1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Page_Up, 0,
                                        GTK_MOVEMENT_PAGES, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Page_Up, 0,
                                        GTK_MOVEMENT_PAGES, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Page_Down, 0,
                                        GTK_MOVEMENT_PAGES, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Page_Down, 0,
                                        GTK_MOVEMENT_PAGES, 1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Left, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Left, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_Right, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_KP_Right, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, 1);
...
#if 0
  /* VI keybindings */
  mcharmap_chartable_add_move_binding (binding_set, GDK_k, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_K, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_j, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_J, 0,
                                        GTK_MOVEMENT_DISPLAY_LINES, 1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_b, 0,
                                        GTK_MOVEMENT_PAGES, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_B, 0,
                                        GTK_MOVEMENT_PAGES, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_h, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, -1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_H, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, -1);

  mcharmap_chartable_add_move_binding (binding_set, GDK_l, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, 1);
  mcharmap_chartable_add_move_binding (binding_set, GDK_L, 0,
                                        GTK_MOVEMENT_VISUAL_POSITIONS, 1);
#endif
...
/**
 * mcharmap_chartable_new:
 *
 * Returns: a new #McharmapChartable
 */
GtkWidget *
mcharmap_chartable_new (void)
{
  return GTK_WIDGET (g_object_new (mcharmap_chartable_get_type (), NULL));
}

/**
 * mcharmap_chartable_set_zoom_enabled:
 * @chartable: a #McharmapChartable
 * @enabled: whether to enable zoom mode
 *
 * Enables or disables the zoom popup.
 */
void
mcharmap_chartable_set_zoom_enabled (McharmapChartable *chartable,
                                      gboolean enabled)
{
  McharmapChartablePrivate *priv;
  GObject *object;

  g_return_if_fail (MCHARMAP_IS_CHARTABLE (chartable));
...
/**
 * mcharmap_chartable_get_zoom_enabled:
 * @chartable: a #McharmapChartable
 *
 * Returns: whether zooming is enabled
 */
gboolean
mcharmap_chartable_get_zoom_enabled (McharmapChartable *chartable)
{
  g_return_val_if_fail (MCHARMAP_IS_CHARTABLE (chartable), FALSE);

  return chartable->priv->zoom_mode_enabled;
}

/**
 * mcharmap_chartable_set_font_desc:
 * @chartable: a #McharmapChartable
 ...
 */
void
mcharmap_chartable_set_font_desc (McharmapChartable *chartable,
                                   PangoFontDescription *font_desc)
{
  McharmapChartablePrivate *priv;
  ...
  mcharmap_chartable_set_font_desc_internal (chartable,
                                              pango_font_description_copy (font_desc));
}

/**
 * mcharmap_chartable_get_font_desc:
 * @chartable: a #McharmapChartable
 *
...
mcharmap_chartable_get_font_desc (McharmapChartable *chartable)
{
  g_return_val_if_fail (MCHARMAP_IS_CHARTABLE (chartable), NULL);

  return chartable->priv->font_desc;
}

/**
 * mcharmap_chartable_get_active_character:
 * @chartable: a #McharmapChartable
 *
 * Returns: the currently selected character
 */
gunichar
mcharmap_chartable_get_active_character (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
  ...
  return mcharmap_codepoint_list_get_char (priv->codepoint_list, priv->active_cell);
}
 ...
 */
void
mcharmap_chartable_set_active_character (McharmapChartable *chartable, 
                                          gunichar wc)
{
  set_active_char (chartable, wc);
  _mcharmap_chartable_redraw (chartable, TRUE);
...
/**
 * mcharmap_chartable_set_snap_pow2:
 * @chartable: a #McharmapChartable
 ...
 */
void
mcharmap_chartable_set_snap_pow2 (McharmapChartable *chartable,
                                   gboolean snap)
{
  McharmapChartablePrivate *priv = chartable->priv;
...
/**
 * mcharmap_chartable_get_snap_pow2:
 * @chartable: a #McharmapChartable
 *
 ...
 */
gboolean
mcharmap_chartable_get_snap_pow2 (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
 ...
 */
void
mcharmap_chartable_set_codepoint_list (McharmapChartable     *chartable,
                                        McharmapCodepointList *codepoint_list)
{
  ...
  priv->page_first_cell = 0;
  if (codepoint_list)
    priv->last_cell = mcharmap_codepoint_list_get_last_index (codepoint_list);
  else
    priv->last_cell = 0;
...
/**
 * mcharmap_chartable_get_codepoint_list:
 * @chartable: a #McharmapChartable
 *
 * Returns: the current codepoint list
 */
McharmapCodepointList *
mcharmap_chartable_get_codepoint_list (McharmapChartable *chartable)
{
  McharmapChartablePrivate *priv = chartable->priv;
