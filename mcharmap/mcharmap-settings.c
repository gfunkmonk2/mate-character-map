...
void
mcharmap_settings_initialize (void)
{
...
static gboolean
mcharmap_settings_initialized (void) 
{
  return (client != NULL);
}
...
void
mcharmap_settings_set_snap_pow2 (gboolean snap_pow2)
{
  if (!mcharmap_settings_initialized ()) {
      return;
  }
